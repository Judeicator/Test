...
public class medium extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Submit = findViewById(R.id.medium_submit);
        Back = findViewById(R.id.medium_back);

        C1 = findViewById(R.id.mc1);
        C2 = findViewById(R.id.mc2);
        C3 = findViewById(R.id.mc3);
        W1 = findViewById(R.id.mw1);
        W2 = findViewById(R.id.mw2);
        W3 = findViewById(R.id.mw3);
        W4 = findViewById(R.id.mw4);
        W5 = findViewById(R.id.mw5);
        W6 = findViewById(R.id.mw6);
